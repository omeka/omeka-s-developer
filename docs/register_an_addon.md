...
After you [register your GitHub repository](http://omeka.org/addons/register/) as an Omeka addon we'll publish new versions of your addon if you follow these steps.
